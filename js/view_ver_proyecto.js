...
function eventListeners(){
    ...
    // Boton para actualizar el nuevo comentario en la bd como arqui.
    document.getElementById('btnActualizarComentarioArqui').addEventListener('click',ActualizarComentarioArqui);
